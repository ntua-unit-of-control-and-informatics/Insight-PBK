...
predicted.feats <- c("Alung_int_ub", "Alung_int_alb", "Alung_int_mcr",
                     "Alung_vas_ub", "Alung_vas_alb", "Alung_vas_mcr",
                     "Aart_ub", "Aart_alb", "Aart_mcr", "Aven_ub",
                     "Aven_alb", "Aven_mcr", "Asurf_ub", "Ascve_ub",
                     "Ascve_alb", "Ascve_mcr" , "Askn_ub", "Askn_mcr",
                     "Alum", "Akid_ub", "Akid_mcr", "Auri_amine", "Aurine",
                     "Afeces", "Arem_ub", "Vuri", 
                     "Clung_int_ub", "Clung_int_alb", "Clung_int_mcr",
                     "Clung_vas_ub", "Clung_vas_alb", "Clung_vas_mcr",
                     "Cart_ub", "Cart_alb", "Cart_mcr",
                     "Cven_ub", "Cven_alb", "Cven_mcr",
                     "Curine",  "Curine_amine")
setwd("Scholten et al.2023")
