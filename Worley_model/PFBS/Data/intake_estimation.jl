...
half_life_data = CSV.read("Worley_model/PFBS/Data/PFBS_half_life_data.csv", DataFrame)
...
CSV.write("Worley_model/PFBS/Data/intake_estimation_results.csv", half_life_data)
