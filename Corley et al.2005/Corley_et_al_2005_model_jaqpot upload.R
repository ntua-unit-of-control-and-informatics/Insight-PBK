...
create.params <- function(user.input) {
  with(as.list(user.input), {
    ...
    return(list('BW' = BW, 'QC' = QC, 'Q_alv' = Q_alv, 'Vplasma'=Vplasma,
                ...
                'inhalation'=inhalation, 'inhalation_time'=inhalation_time
...
create.inits <- function(parameters){
  with(as.list(parameters),{
    ...
    Cum_urine_GA <- 0; Cum_met_GA <-0; inhalation <- 0
...
#======================================================================================== 
    ...
    return(list(c('dA_ven_EG'=dA_ven_EG, 'dA_ven_GA'=dA_ven_GA,
                  ...
                  'dCum_urine_GA'=dCum_urine_GA, 'dCum_met_GA'=dCum_met_GA, 'dinhalation'=dinhalation),
